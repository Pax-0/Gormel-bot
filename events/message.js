...
async function handler(msg){
	...
	if( !msg.channel.guild || !settings.automod.enabled || settings.owners.includes(msg.author.id) || ( msg.member && settings.modRoles.some(modRole => msg.member.roles.includes(modRole)) ) ) return;
